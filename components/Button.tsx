...
const variantClasses = {
    main:
        "cursor-pointer font-semibold text-base md:text-lg rounded-md py-2 px-4 dark:text-neutral-100 dark:hover:text-gray-100 dark:bg-teal-500 disabled:opacity-50 disabled:pointer-events-none hover:scale-105 transition-all duration-300",
    default:
