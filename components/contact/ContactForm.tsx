    ...
    return (
        <section className="mt-8 mx-auto w-full max-w-md">
            <p className="text-gray-700 dark:text-gray-300">
                ...
                <br />
                feel free to contact me or just <a className="text-teal-400 underline hover:text-teal-500 dark:text-teal-400 dark:hover:text-teal-300" href="mailto:fabiancava22@gmail.com">shoot me an email.</a>
            </p>
            <form
                className="mt-4"
            ...
            >
                <div className="flex flex-col gap-4 w-full">
                    <input
                        className="border-2 border-gray-200 dark:border-purple-800/20 rounded-md py-2 px-4 focus:outline-none focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-500"
                        type="text"
                        name="name"
                        placeholder="Name"
                        value={name}
                    ...
                    />
                    <textarea
                        className="border-2 border-gray-200 dark:border-purple-800/20 rounded-md py-2 px-4 min-h-[120px] focus:outline-none focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-500"
                        name="message"
                        placeholder="Message"
                        value={message}
