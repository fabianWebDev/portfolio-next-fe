    ...
    return (
        <>
            <section className="mt-10">
                <h2 className="font-[family-name:var(--font-sekuya)] text-2xl sm:text-3xl font-semibold dark:text-teal-500/90 tracking-widest text-shadow-2xs dark:text-shadow-purple-600">
                    My Mission
                </h2>
